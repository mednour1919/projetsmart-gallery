...
""));
        ...
        label_2->setGeometry(QRect(40, 270, 121, 31));
        id_t = new QLineEdit(page_2);
        id_t->setObjectName(QStringLiteral("id_t"));
        id_t->setGeometry(QRect(170, 280, 113, 22));
...
"}"));
    ...
    void retranslateUi(QDialog *Pageoeuvre)
    {
        ...
        label_2->setText(QApplication::translate("Pageoeuvre", "id transaction", Q_NULLPTR));
